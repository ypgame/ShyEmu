ShyEmu Win32/64 Libraries Distribution
======================================
...
Depending on the Shyhitecture you want to build for, build the configuration:
...
When you update ShyEmu, this doesn't need to be done each time.

Now you can build ShyEmu as normal.